...
pixi add redshift_connector
# for installing globally
pixi global install redshift_connector
```
...
It is possible to list all of the versions of `redshift_connector` available on your platform:
...
```
pixi search redshift_connector --channel conda-forge
```
